...
public class HttpAuth {
    ...
    public static String generateCodeChallenge(String codeVerifier) throws NoSuchAlgorithmException {
     ...
     public String authenticateMyAccount() throws IOException, NoSuchAlgorithmException, InterruptedException, URISyntaxException {
    ...
    public String getToken(String authCode, String challenge, String verifier) throws URISyntaxException, IOException, InterruptedException {
